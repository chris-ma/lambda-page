...
> = {
  ...
  2: {
    ...
    what: "Reach, Engagement & Conversion turns real visitor activity into hard numbers once a page is live: campaign/channel quality for Reach, click density and rage-clicks for Engagement, and stage-to-stage funnel drop-off segmented by device and source for Conversion — either built in via Lambda Analytics or read from a connected Google Analytics 4 property.",
  },
  3: {
