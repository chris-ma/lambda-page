...
const DESCRIPTIONS: Record<number, string> = {
  ...
  2: "Once the page is live, this is what real visitors are actually doing on it: heatmaps and session replay, funnel drop-off by stage, field-level form analytics, real-user Core Web Vitals, and campaign/channel quality — built in, or pulled from Google Analytics 4.",
