...
export default function NewWireframe() {
  return (
    <div>
      ...
      <h1 className="mt-2 font-display text-[26px] font-semibold text-ink">Wireframe Analysis</h1>
      <p className="mt-2 max-w-[620px] text-[13.5px] text-ink-soft">
        Upload a prototype screenshot, or scan a live prototype URL directly, and Claude gives
        visual + content critique — pinned to the exact spot on the image — before you invest in a
        build. Every finding is flagged as an AI judgment call, not a measured fact.
      </p>
      <ToolExplainer
        what="Upload a prototype or wireframe screenshot — or point at a live prototype URL and let it be scanned directly — and get the same visual and content critique a finished page would get, pinned to the exact spot on the image."
